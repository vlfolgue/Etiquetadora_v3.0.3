...
void setup() {
 ...
 ////// ---> Calculamos la calibracion de las FC:
  ...
  valor_corte_FC_min = media_FC1 - 100;  // --> Se peude ajustar precision bajando a menos de 100.
  valor_corte_FC2_min = media_FC2 - 100; // --> Se peude ajustar precision bajando a menos de 100.
